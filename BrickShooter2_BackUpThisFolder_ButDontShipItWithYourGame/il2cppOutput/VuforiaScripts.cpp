...
// T[] UnityEngine.Component::GetComponentsInChildren<UnityEngine.Rigidbody>(System.Boolean)
...
{
	return ((  RigidbodyU5BU5D_t052E8AB174C34DFD0EBB5E897554DEBB841CC649* (*) (Component_t39FBE53E5EFCF4409111FB22C15FF73717632EC3*, bool, const RuntimeMethod*))Component_GetComponentsInChildren_TisRuntimeObject_m90734C3A39A158985239CB90DE2F0792F1D99926_gshared)(__this, ___includeInactive0, method);
}
...
IL_007f:
	...
	}
	{
		...
		RigidbodyU5BU5D_t052E8AB174C34DFD0EBB5E897554DEBB841CC649* L_31;
		L_31 = Component_GetComponentsInChildren_TisRigidbody_t268697F5A994213ED97393309870968BC1C7393C_m08D659F1E5FC2C7259BEFFA20C135D3D2EB93CA1(__this, (bool)1, Component_GetComponentsInChildren_TisRigidbody_t268697F5A994213ED97393309870968BC1C7393C_m08D659F1E5FC2C7259BEFFA20C135D3D2EB93CA1_RuntimeMethod_var);
...
IL_0093:
	{
		// foreach (var component in rigidbodies)
		RigidbodyU5BU5D_t052E8AB174C34DFD0EBB5E897554DEBB841CC649* L_32 = V_6;
		int32_t L_33 = V_3;
		NullCheck(L_32);
		int32_t L_34 = L_33;
		Rigidbody_t268697F5A994213ED97393309870968BC1C7393C* L_35 = (L_32)->GetAt(static_cast<il2cpp_array_size_t>(L_34));
		// component.useGravity = true;
		NullCheck(L_35);
		Rigidbody_set_useGravity_m1B1B22E093F9DC92D7BEEBBE6B02642B3B6C4389(L_35, (bool)1, NULL);
		int32_t L_36 = V_3;
...
IL_00a1:
	{
		// foreach (var component in rigidbodies)
		int32_t L_37 = V_3;
		RigidbodyU5BU5D_t052E8AB174C34DFD0EBB5E897554DEBB841CC649* L_38 = V_6;
		NullCheck(L_38);
